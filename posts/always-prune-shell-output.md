...
I've read a similar issue someone faced with Ruby where the shell output of find (?) was taken as an input to the file. This was the formatted output, with all the jingbang colors and what not, causing ridiculous symbols appearing in the middle. Lesson: When in doubt, prune your input
